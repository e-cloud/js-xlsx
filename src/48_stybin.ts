...
import { evert } from './20_jsutils'
import { new_buf, parsenoop } from './23_binutils'
...
export function parse_BrtFont(data, length: number, opts) {
    const out = {}
...
const rev_XLSBFillPTNames: EvertNumType = evert(XLSBFillPTNames)
...
/* [MS-XLSB] 2.1.7.50 Styles */
export function write_sty_bin(wb, opts) {
    const ba = buf_array()
