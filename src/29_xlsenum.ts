...
export const VT_VARIANT = 0x000C
...
export const VT_USTR = 0x0051 // 2.3.3.1.12 VtUnalignedString
export const VT_CUSTOM = [VT_STRING, VT_USTR]

/* [MS-OSHARED] 2.3.3.2.2.1 Document Summary Information PIDDSI */
export const DocSummaryPIDDSI = {
