import { parsexmltag, tagregex, XML_HEADER } from './22_xmlutils'
...
const clrsregex = /<a:clrScheme([^>]*)>[^\u2603]*<\/a:clrScheme>/
const fntsregex = /<a:fontScheme([^>]*)>[^\u2603]*<\/a:fontScheme>/
const fmtsregex = /<a:fmtScheme([^>]*)>[^\u2603]*<\/a:fmtScheme>/
