import { writetag, writextag, wxt_helper, XLMLNS } from './22_xmlutils'
import { decode_cell } from './27_csfutils'

/* L.5.5.2 SpreadsheetML Comments + VML Schema */
export let _shapeid = 1024

export function resetShapeId() {
    _shapeid = 1024
}

export function write_comments_vml(rId, comments) {
