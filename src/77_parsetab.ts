...
import {
    ...
    parse_ColInfo,
    parse_Compat12,
    parse_CompressPictures,
    parse_CondFmt,
    parse_CondFmt12,
    parse_Continue,
    parse_ContinueBigName,
    parse_ContinueFrt,
    parse_ContinueFrt11,
    parse_ContinueFrt12,
    parse_Country,
    ...
    parse_Mms,
    parse_MsoDrawing,
    parse_MsoDrawingGroup,
    parse_MsoDrawingSelection,
    parse_MTRSettings,
    parse_MulBlank,
    parse_MulRk,
    parse_NameCmt,
    ...
    parse_Table,
    parse_TableStyle,
    parse_TableStyleElement,
    parse_TableStyles,
    parse_Template,
    parse_Text,
    parse_TextPropsStream,
    parse_Tick,
    parse_TopMargin,
    parse_TxO,
    parse_TxtQry,
...
import { parse_BrtBundleSh, parse_BrtFRTArchID$, parse_BrtName, parse_BrtWbProp } from './73_wbbin'

export const XLSBRecordEnum = {
...
export const evert_RE = evert_key(XLSBRecordEnum, 'n')

/* [MS-XLS] 2.3 Record Enumeration */
export const XLSRecordEnum = {
