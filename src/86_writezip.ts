...
import { write_core_props } from './33_coreprops'
import { write_ext_props } from './34_extprops'
import { write_cust_props } from './35_custprops'
import { write_theme } from './49_theme'
...
export function write_zip(wb /*:Workbook*/, opts /*:WriteOpts*/) /*:ZIP*/ {
    ...
    const vbafmt = opts.bookType == 'xlsb' || opts.bookType == 'xlsm'
    const ct = {
