...
export function parse_xlml_xml(d, opts) /*:Workbook*/ {
    ...
    if (str.substr(0, 1000).includes('<html')) {
...
function write_ws_xlml(idx /*:number*/, opts, wb /*:Workbook*/) /*:string*/ {
    ...
    /* Table */
    const t = ws ? write_ws_xlml_table(ws, opts, idx, wb) : ''
    if (t.length > 0) {
