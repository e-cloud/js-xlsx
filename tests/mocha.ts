;(function () {
        ...
        class Landing extends F {
            constructor(runner) {
                ...
                runner.on('test end', function (test) {
                    ...
                    const col = -1 == crashed ? width * ++n / total | 0 : crashed
    ...
    require.register('runnable.js', function (module, exports, require) {
        ...
        const EventEmitter = require('browser/events').EventEmitter
    ...
    require.register('runner.js', function (module, exports, require) {
        ...
        const globals = ['setTimeout', 'clearTimeout', 'setInterval', 'clearInterval', 'XMLHttpRequest', 'Date']
    ...
    require.register('utils.js', function (module, exports, require) {
        ...
        exports.clean = function (str) {
            ...
            const whitespace = str.match(/^\n?(\s*)/)[1]
            const re = new RegExp(`^${whitespace}`, 'gm')
